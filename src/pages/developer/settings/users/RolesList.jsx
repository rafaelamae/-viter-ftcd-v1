...
const RolesList = ({ itemEdit, setItemEdit }) => {
  ...
  const {
    ...
    queryFn: async ({ pageParam = 1 }) =>
      await queryDataInfinite(
        ``,
        `${apiVersion}/controllers/developers/users/roles-ctrl/page.php?start=${pageParam}`,
        false,
        {
          filterData,
  ...
  return (
    <>
      ...
      {store.isArchive && (
        <ModalArchive
          mysqlApiArchive={`${apiVersion}/controllers/developers/users/roles-ctrl/active.php?id=${itemEdit.role_aid}`}
          dataItem={itemEdit}
      ...
      {store.isRestore && (
        <ModalRestore
          mysqlApiRestore={`${apiVersion}/controllers/developers/users/roles-ctrl/active.php?id=${itemEdit.role_aid}`}
          dataItem={itemEdit}
      ...
      {store.isDelete && (
        <ModalDelete
          mysqlApiDelete={`${apiVersion}/controllers/developers/users/roles-ctrl/roles.php?id=${itemEdit.role_aid}`}
          dataItem={itemEdit}
          msg="Are you sure you want to permanently delete this role?"
